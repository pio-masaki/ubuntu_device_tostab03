...
# ramdisk
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/prebuilt/ramdisk/init.antares.usb.rc:root/init.antares.usb.rc \
    $(LOCAL_PATH)/prebuilt/ramdisk/ueventd.antares.rc:root/ueventd.antares.rc \
    $(LOCAL_PATH)/prebuilt/ramdisk/init.antares.rc:root/init.antares.rc \
    $(LOCAL_PATH)/prebuilt/ramdisk/fstab.antares:root/fstab.antares 
